...
from tests.lib.utils import IMAGE_TYPE, RELEASE_NAME
...
class TestInputs(unittest.TestCase):
    ...
    def test_check_version(self):
        self.assertIsNone(check_inputs.check_version(
            RELEASE_NAME, RELEASE_NAME, self.log))
    ...
    def test_check_image(self):
        self.assertIsNone(check_inputs.check_image(
            self.type, self.type, self.log))
