...
from amazon_emr_serverless_image_cli.validation_tool.validation_models.validation_models import \
    ManifestConfig
from amazon_emr_serverless_image_cli.validation_tool.validation_tests.check_manifest import \
    CheckManifest
...
class TestManifest(unittest.TestCase):
    ...
    def test_check_manifest(self):
        with self.assertLogs(self.log.log) as l:
            manifest_check_instance = CheckManifest(
                self.inspect, self.manifest_config, self.log)
