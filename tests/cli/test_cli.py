...
from amazon_emr_serverless_image_cli.cli import cli
from tests.lib.utils import IMAGE, IMAGE_TYPE, RELEASE_NAME


class TestCli(unittest.TestCase):

    @mock.patch("amazon_emr_serverless_image_cli.helper.print_message.print_pre_verification_text")
    @mock.patch("amazon_emr_serverless_image_cli.helper.argument_parser.parse_commandline_arguments")
    @mock.patch("amazon_emr_serverless_image_cli.commands.validate_image.ValidateImage.run")
    @mock.patch("amazon_emr_serverless_image_cli.commands.validate_image.ValidateImage.initiate")
    @mock.patch("amazon_emr_serverless_image_cli.commands.validate_image.ValidateImage.__init__")
