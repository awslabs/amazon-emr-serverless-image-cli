...
from amazon_emr_serverless_image_cli import __version__
from amazon_emr_serverless_image_cli.helper import print_message


class TestPrintMessage(unittest.TestCase):
    @mock.patch('sys.stdout', new_callable=io.StringIO)
    def test_print_pre(self, mock_stdout):
        expected = "Amazon EMR Serverless - Image CLI\nVersion: %s\n" % __version__
