...
class testValidateImage(unittest.TestCase):
    ...
    @mock.patch("amazon_emr_serverless_image_cli.helper.docker_util.docker_cl.DockerCommand.close_docker")
    @mock.patch("amazon_emr_serverless_image_cli.helper.docker_util.docker_cl.DockerCommand.__init__")
    @mock.patch("amazon_emr_serverless_image_cli.commands.validate_image.ValidateImage.initiate")
    @mock.patch("amazon_emr_serverless_image_cli.validation_tool.validation_helper.validate_all")
    def test_run(self, validate_all, initiate, docker_cmd_constructor, close_docker):
        ...
        args = Namespace(local_image_uri=IMAGE,
    ...
    @mock.patch("amazon_emr_serverless_image_cli.helper.docker_util.docker_helper.verify_docker")
    @mock.patch("amazon_emr_serverless_image_cli.helper.docker_util.docker_cl.DockerCommand.docker_inspect")
    @mock.patch("amazon_emr_serverless_image_cli.helper.docker_util.docker_cl.DockerCommand.__init__")
    @mock.patch("amazon_emr_serverless_image_cli.helper.manifest_reader.load_yaml")
    @mock.patch("amazon_emr_serverless_image_cli.helper.logging.Log.info")
    @mock.patch("amazon_emr_serverless_image_cli.helper.logging.Log.error")
    @mock.patch("amazon_emr_serverless_image_cli.helper.logging.Log.__init__")
